## ansible 
- 位置在上周老師給的ansible中的ansible/project3
...
### project4
- 職場上可能會遇到大量的伺服器，會分不同的群組
所以在project4的group_vars
...
- 結構
  ```
  [root@centos7-2 project5-1]# tree
  .
  ├── group_vars
  │   └── servers
  ├── host_vars
